  ...
  return (
    <div
      ...
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className="relative w-auto p-5 flex justify-center items-center max-w-full shrink-0   px-4 py-6 md:w-[450px]"
            key={idx}>
            <blockquote>
              <div
                aria-hidden="true"
                className="user-select-none pointer-events-none absolute -top-0.5 -left-0.5 -z-1 h-[calc(100%_+_4px)] w-[calc(100%_+_4px)]"></div>
            <Image src={item.img} width={200} height={200} alt="company"  className="w-full object-cover"/>
            </blockquote>
          </li>
        ))}
      </ul>
